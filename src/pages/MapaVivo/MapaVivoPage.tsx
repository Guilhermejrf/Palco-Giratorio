...
export const MapaVivoPage = () => {
  ...
  const addCircuit = useDemoDataStore((state) => state.addCircuit)

  const createProposal = () => {
    const circuit = addCircuit({
      showId: shows[0].id,
      cityIds: ['caruaru', 'arcoverde', 'recife', 'olinda'],
      contractorNames: ['Sesc Caruaru', 'Sesc Arcoverde', 'Sesc Recife', 'Prefeitura de Olinda'],
      name: 'Proposta Mapa Vivo',
    })
